...
public class MyStructureFindByRendererMethodTests {
    public MyStructureFindByRendererMethodTests() {
    }
    ...
    @Test
    public void test_1_FindBy_Renderer_NotNestedNode() {
        Assertions.assertEquals(myTestStructure.findByRenderer("renderer13"), SEARCHED_NODE_TEST_1);
    }
    @Test
    public void test_2_FindBy_Renderer_CodeCompositeNode() {
        Assertions.assertEquals(myTestStructure.findByRenderer("renderer3"), SEARCHED_COMPOSITE_NODE_TEST_2);
    }
    @Test
    public void test_3_FindBy_Renderer_NestedNode() {
        Assertions.assertEquals(myTestStructure.findByRenderer("renderer12"), SEARCHED_NODE_TEST_3);
    }
    @Test
    public void test_4_FindBy_Renderer_HighlyNestedNode() {
        Assertions.assertEquals(myTestStructure.findByRenderer("renderer5"), SEARCHED_NODE_TEST_4);
    }
